...
- Escolha da crate SSH pode afetar SFTP e port forwarding futuros; local forwarding deve ser requisito minimo antes de fechar a decisao.
- Politica de host key precisa equilibrar seguranca e UX.
